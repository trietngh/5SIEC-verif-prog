...
typedef unsigned long PROGRAMCOUNTER;

#define STRINGFIFOSIZE	256
#define CALLSTACKDEPTH	128
#define MAXVARS			8000

#define DEBUGGER		// Enable the Debbugger
#define EMGSLEEP(x)		Sleep(x)
...
#define DEBUGGER		// Enable the Debbugger
#define EMGSLEEP(x)		usleep(x*1000)
